...
namespace CompiladorDART_RCTR
{
    public class VerificadorTipos
    {
        ...
        public void EjecutarVerificacionTipos(NodoArbol arbolSintactico)
        {
            ...
            if(arbolSintactico.soyDeTipoNodo == TipoNodoArbol.Sentencia && arbolSintactico.soySentenciaDeTipo == TipoSentencia.ASIGNACION)
            {
                RecorridoAsignacion(arbolSintactico);
            }
            if(arbolSintactico.soyDeTipoNodo == TipoNodoArbol.Sentencia && arbolSintactico.soySentenciaDeTipo == TipoSentencia.FOR)
            {
                RecorridoFor(arbolSintactico);
            }
            if(arbolSintactico.soyDeTipoNodo == TipoNodoArbol.Sentencia && arbolSintactico.soySentenciaDeTipo == TipoSentencia.IF)
            {
                RecorridoIF(arbolSintactico);
            }
            if(arbolSintactico.soyDeTipoNodo == TipoNodoArbol.Sentencia && arbolSintactico.soySentenciaDeTipo == TipoSentencia.ESCRIBIR)
            {
                RecorridoAsignacion(arbolSintactico);
            }
            if(arbolSintactico.hermano != null)
        ...
        public void EjecutarHermano(NodoArbol arbolSintactico)
        {
            if (arbolSintactico.soyDeTipoNodo == TipoNodoArbol.Sentencia && arbolSintactico.soySentenciaDeTipo == TipoSentencia.ASIGNACION)
            {
                RecorridoAsignacion(arbolSintactico);
        ...
        */
        ...
        public void RecorridoIF(NodoArbol miArbol)
        {
            ...
            {
                EjecutarVerificacionTipos(miArbol.hijoDerecho);
            }

        }

        public void RecorridoFor(NodoArbol miArbol)
        {
            RecorridoAsignacion(miArbol.hijoIzquierdo);
            RecorridoCondicional(miArbol.hijoDerecho);
            RecorridoAsignacion(miArbol.hijoCentro);
        }
